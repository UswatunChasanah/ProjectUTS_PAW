...
<body>
	...
	$sql = "UPDATE data_murid set nama_murid = '$nama', tgl_lahir_murid = '$tglLahir', nama_ayah = '$namaAyah', nama_ibu = '$namaIbu', nomor_tlp_ortu = '$notlp',  alamat = '$alamat', kelas = '$kelas' WHERE id_murid = $id";
	...
	if (!$hasil) { ?>
		<div style="position: absolute;width: 665px;height: 125px;left: 379px;top: 144px;background: rgba(2, 168, 168, 0.75);border-radius: 10px;">
			<p style="position: absolute;width: 616px;height: 47px;left: 404px;top: 160px;font-family: 'Inter';font-style: normal;font-weight: 700;font-size: 30px;line-height: 36px;text-align: center;color: #FFFFFF;">Data Murid Gagal Diedit</p>
		</div>
	<?php } else { ?>
		<div style="position: absolute;width: 665px;height: 125px;left: 379px;top: 144px;background: rgba(2, 168, 168, 0.75);border-radius: 10px;">
			<p style="position: absolute;left: 150px;top: -20px;font-family: sans-serif;font-style: normal;font-weight: 700;font-size: 30px;line-height: 36px;text-align: center;color: #FFFFFF;">Data Murid Berhasil Diedit</p>
