...
<body>
	<div style="position: absolute;width: 1440px;height: 1024px;left: 0px;top: 0px;background: linear-gradient(180deg, #EA86AB -56.1%, rgba(255, 255, 255, 0) 82.76%);"></div>
	...
	<div style="position: absolute;width: 1220px;height: 883px;left: 110px;top: 119px;background: #FFFFFF;box-shadow: 20px 20px 20px rgba(0, 0, 0, 0.25);border-radius: 30px 30px 0px 0px;">
		<p style="position: absolute;width: 370px;height: 101.06px;left: 50px; top: 20px; font-family: sans-serif;font-style: normal;font-weight: 700;font-size: 40px;line-height: 48px;color: #000000;">Data Murid Kelas A</p>
		<br><br><br><br>
		<table class="table" width="80%" style="text-align: center;">
		  ...
		  <tbody>
		  	<?php 	 
				...
				$sql = "SELECT * FROM data_murid WHERE kelas = 'A'";
